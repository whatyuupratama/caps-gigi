...
//   const [previewUrl, setPreviewUrl] = useState<string | null>(null); // Store one preview URL

//   const handleFileChange = (newFiles: File[]) => {
//     const selectedFile = newFiles[0]; // Only take the first file
//     setFile(selectedFile); // Update state with the new file
//     onChange && onChange([selectedFile]); // Call onChange with the single file
