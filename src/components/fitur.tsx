...
import { AnimatedBeamDemo } from '@/components/fragments/molecule/AnimatedBeamDemo';
const Fitur = () => {
  return (
    <div
      id='fitur-section'
      ...
      <div className='flex flex-col text-center'>
        ...
        <div className='flex flex-col w-screen bg-[#87003d] h-auto py-16 px-5 mt-16 gap-15 '>
          <div className='flex justify-center '>
            <div className='flex justify-between gap-12 items-center max-w-5/3 '>
        ...
        <div className='flex justify-center bg-[#87003d] border-t-2 border-dashed border-t-white'>
          <div className='flex w-full justify-between  items-center max-w-3/3 py-4 pb-26'>
            <AnimatedBeamDemo />
            <div className='flex flex-col w-1/2 items-start gap-3'>
              <span className='text-3xl font-bold'>
                {' '}
